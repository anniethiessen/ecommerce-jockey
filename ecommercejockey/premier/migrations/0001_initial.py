# Generated by Django 2.2.5 on 2019-10-22 23:05
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ('inventory_ab',
                         models.IntegerField(blank=True, help_text='API field',
                                             null=True,
                                             verbose_name='Alberta '
                                                          'inventory')),
                        ('inventory_po',
                         models.IntegerField(blank=True, help_text='API field',
                                             null=True,
                        ...
                        ('inventory_wa',
                         models.IntegerField(blank=True, help_text='API field',
                                             null=True,
                                             verbose_name='Washington '
                                                          'inventory')),
                        ('inventory_co',
                         models.IntegerField(blank=True, help_text='API field',
                                             null=True,
                                             verbose_name='Colorado '
                                                          'inventory')),
                        ('cost_cad',
                        ...
                        ('premier_part_number',
                         models.CharField(max_length=20, primary_key=True,
                        ...
                        ('weight',
                         models.DecimalField(blank=True, decimal_places=2,
                                             help_text='lbs', max_digits=10,
                                             null=True)),
                        ('length',
                         models.DecimalField(blank=True, decimal_places=2,
                                             help_text='in', max_digits=10,
                                             null=True)),
                        ('width',
                         models.DecimalField(blank=True, decimal_places=2,
                                             help_text='in', max_digits=10,
